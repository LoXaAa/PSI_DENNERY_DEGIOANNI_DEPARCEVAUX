...
namespace PSI_RENDU1
{
    public static class Database
    {
        ...
        public static void InitDatabase()
        {
            ...
            try
            {
                string connectionString = "Server=localhost;Database=livparis;UID=root;Password=root;SslMode=none;AllowPublicKeyRetrieval=True;";
        ...
        public static int AjouterCompte()
        {
            ...
            try
            {
                ...
                if (rowsAffected > 0)
                {
                    ...
                    MySqlCommand getIdCmd = new MySqlCommand("SELECT LAST_INSERT_ID();", GetConnection());
        ...
        public static void AjouterClient(int idCompte)
        {
            Program.Titre();
            if (idCompte <= 0)
            {
        ...
        public static void AjouterCuisinier(int idCompte)
        {
            Program.Titre();
            if (idCompte <= 0)
            {
